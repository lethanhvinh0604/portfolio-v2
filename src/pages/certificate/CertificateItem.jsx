...
const CertificateItemWrapper = styled.section`
  ...
  && .certificate-item {
    ...
    background:
      ...
      radial-gradient(circle at 14% 0%, ${({ theme }) => theme.accentPrimary}1a, transparent 22rem);
    border: 1px solid ${({ theme }) => theme.borderColor};
  ...
  && .certificate-item__info p {
    font-size: 1.45rem;
    line-height: 1.7;
    color: ${({ theme }) => theme.textSecondary};
  }

  && .certificate-item__info .divider {
    margin-top: 14px;
    padding-top: 12px;
    border-top: 1px solid ${({ theme }) => theme.borderColor};
  }

  && .certificate-item__info strong {
    color: ${({ theme }) => theme.textPrimary};
    font-weight: 700;
  }
